import { SET_COORD, SET_ZOOM, SET_STYLE, NEED_ADDRESS_END, USE_MILLIGRATICULE, SET_POPUP_STATUS, OPEN_ABOUT_WINDOW, CLOSE_ABOUT_WINDOW, OPEN_INPUT_COORD_WINDOW, CLOSE_INPUT_COORD_WINDOW, UPDATE_INPUT_COORD, IMPORT_INPUT_COORD } from "../utils/urlConstants";
import { URL_MAP, URL_STYLE, URL_GEOHASH, URL_ZOOM, URL_FORMAT, URL_GOOGLE, URL_HUMAN } from "../utils/urlConstants";
